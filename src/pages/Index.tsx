        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center space-y-8 animate-fade-in-up">
            ...
            <h1 className="text-5xl md:text-7xl font-display font-bold leading-tight">
              Building Tomorrow's
              <span className="text-gradient block">Intelligence Today</span>
            </h1>
            
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Croevo AI is at the forefront of artificial intelligence innovation, 
              creating solutions that transform industries and empower businesses worldwide.
            </p>
          ...
          <div className="relative rounded-2xl glass overflow-hidden p-12 text-center">
            ...
            <div className="relative z-10 space-y-6">
              ...
              <p className="text-muted-foreground max-w-xl mx-auto">
                Join our team of innovators and help build the next generation of AI solutions.
              </p>
              <Link to="/careers">
